...
from .planets.seut_planet_ui                    import (SEUT_UL_PlanetDistributionRulesLayers,
                                                        ...
                                                        SEUT_UL_PlanetWeatherGeneratorsWeathers,
                                                        SEUT_UL_PlanetWeatherGenerators,
                                                        SEUT_UL_PlanetCloudLayersTextures,
                                                        SEUT_UL_PlanetCloudLayers,
                                                        SEUT_UL_PlanetSoundRules,
                                                        ...
                                                        SEUT_PT_Panel_PlanetWeather,
                                                        SEUT_PT_Panel_PlanetCloudLayers,
                                                        SEUT_PT_Panel_PlanetSounds,
                                                        SEUT_PT_Panel_PlanetExport,
                                                        SEUT_PT_Panel_PlanetImport)
from .planets.seut_planets                      import (SEUT_PlanetPropertiesWeatherGenerators,
                                                        SEUT_PlanetPropertiesWeatherGeneratorsWeathers,
                                                        SEUT_PlanetPropertiesCloudLayersTextures,
                                                        SEUT_PlanetPropertiesCloudLayers,
                                                        SEUT_PlanetPropertiesSoundRules,
...
classes = (
    ...
    SEUT_PlanetPropertiesOreMappings,
    SEUT_PlanetPropertiesWeatherGeneratorsWeathers,
    SEUT_PlanetPropertiesWeatherGenerators,
    SEUT_PlanetPropertiesCloudLayersTextures,
    SEUT_PlanetPropertiesCloudLayers,
    SEUT_PlanetPropertiesSoundRules,
